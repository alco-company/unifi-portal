...
module UnifiApiStubs
  ...
  #   ]
  # }
  def stub_unifi_sites_api(base_url = "https://heimdall.test")
  ...
  def stub_unifi_client_api(mac_address, site_id = "test-site-id", base_url = "https://heimdall.test")
  ...
  def stub_guest_authorization_api(base_url = "https://heimdall.test", site_id: "test-site-id", client_id: "497f6eca-6276-4993-bfeb-53cbbbba6f08", api_key: "test-api-key")
